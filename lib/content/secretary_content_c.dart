...
class SecretaryContentTableCel extends StatefulWidget {
  const SecretaryContentTableCel({super.key});

  @override
  State<SecretaryContentTableCel> createState() => _SecretaryContentTableCelState();
}


class _SecretaryContentTableCelState extends State<SecretaryContentTableCel> {
  List<String> cursos = [];
