...
class DeanContentC extends StatefulWidget {
  const DeanContentC({super.key});

  @override
  State<DeanContentC> createState() => _DeanContentCState();
}

class _DeanContentCState extends State<DeanContentC> {
  List<String> cursos = [];
