...
class ProfesorContentTable extends StatefulWidget {
  final String username;
  const ProfesorContentTable({
    Key? key,
    required this.username,
  }): super(key: key);

  @override
  State<ProfesorContentTable> createState() => _ProfesorContentTableState();
}

class _ProfesorContentTableState extends State<ProfesorContentTable> {
  List<String> cursos = [];
