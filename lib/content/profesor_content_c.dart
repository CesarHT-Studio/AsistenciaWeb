...
class ProfesorContentTableC extends StatefulWidget {
  final String username;
  const ProfesorContentTableC({
    Key? key,
    required this.username,
  }): super(key: key);

  @override
  State<ProfesorContentTableC> createState() => _ProfesorContentTableCState();
}

class _ProfesorContentTableCState extends State<ProfesorContentTableC> {
  List<String> cursos = [];
  ...
  Widget build(BuildContext context) {
   ...
   Future<void> cursosTotal(String user) async {
    final apiUrl = 'http://3.22.217.187/api/v2/cursosprofesor/$user';
